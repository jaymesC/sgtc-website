    ...
    <Layout>
      ...
      <StyledContainer>
        ...
        <StyledP>
          ...
          <p>
            <br /> In our world today, a man lays claim to a woman when a dowry
            (bride price) has been paid and the implication of this is that you
            are forever obligated to remain faithful and committed to your vows
            and spouse that is why Society frowns at a man or woman who does not
          ...
          <br />
          <p>
            ❖ Have you made yourself ready if the bridegroom would come now to
          ...
          <br />
          <p>
            ❖ For us to meet the requirement to be a bride meet for Christ, our
            life must be an extension of Christ's. v We must live a Holy life,
            devoid of sin.
          </p>
          <br />
          <p>❖ We must reject the world and its attractions.</p>
          <br />
          <p>❖ We must be fully committed to Christ.</p>
          <br />
          <p>
